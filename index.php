            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative overflow-hidden rounded ps-5 pt-5 h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100" src="img/about.png" alt="" style="object-fit: cover;">
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="admissionModalLabel">The Bernardine Cistercian Sisters of Audenarde</h5>
      ...
      <div class="modal-body">
        ...
        <h6>1. Who are we?</h6>
        <p>The Congregation of the Bernardine Cistercian Sisters of Audenarde was founded in Audenarde, Belgium, around the year 1202.
It currently has two provinces:
</p>
        <ul>
          <li>One in Belgium</li>
          <li>Another in Africa, which includes Rwanda, Chad, and Burkina Faso.</li>
          
        </ul>

        <h6>2. Charism</h6>
        <p>"To seek God and welcome Man, made in the image of God"</p>

        <h6>4. Spirituality</h6>
        <p>The Congregation lives the Cistercian spirituality according to the spirit of Saint Bernard.
This spirituality is an experience of seeking God, emphasizing:
</p>
        <ul>
          <li>Community life, called the “School of Charity”</li>
          <li>Silence in prayer of the heart</li>
          <li>The liturgy: the Eucharist, the Divine Office</li>
          <li>The Word of God read and meditated upon (Lectio Divina)</li>
          <li>Self-knowledge, leading to humility and ongoing conversion through charity</li>
          <li>Simplicity and sobriety of life</li>
          <li>Love of the Church under the guidance of the Virgin Mary, in the example of Saint Bernard</li>
        </ul>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
                        ...
                        <div class="border-top mt-4 pt-4">
                            <div class="d-flex align-items-center">
                                <img class="flex-shrink-0 rounded-circle me-3" src="manseri_" alt="Ifot_manseri">
                                <h5 class="mb-0">Call Us: +250-788-756-894</h5>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
  ...
  // Intersection Observer to run animation once when section is visible
...
<div class="modal fade" id="admissionModal" tabindex="-1" aria-labelledby="admissionModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h5 class="modal-title" id="admissionModalLabel">Admission Requirements & Formation</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      ...
      <div class="modal-body">
        ...
        <h6 style="color: #0059ff;">Admission Requirements</h6>
        <ul>
          <li>A sincere desire to give oneself to God</li>
          <li>An engaged Christian life</li>
          <li>Be between 20 and 30 years of age</li>
          <li>Prior general human and Christian formation, with great openness of mind to benefit effectively from religious life formation and to live well with others</li>
          <li>Completion of high school or vocational training</li>
          <li>At least 2 years of work or life experience after school</li>
        </ul>

        <h6 style="color: #0059ff;">Formation of Young Candidates</h6>
        <p>Young women should contact the community closest to them for more detailed information about their vocation.  
        Currently, the postulancy is carried out in the country of origin if there is already a community there.  
        The novitiate takes place in Rwanda.</p>

        <h6 style="color: #0059ff;">Duration of Initial Formation</h6>
        <ul>
          <li>Pre-postulancy: at least 1 year</li>
          <li>Postulancy: 1 year</li>
          <li>Canonical novitiate: 1 year</li>
          <li>Community stage: 1 year</li>
          <li>Preparation for vows: 6 months</li>
        </ul>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h6 class="text-white mb-4"><img style="width: 50px;height: 50px;" class="img-fluid me-3" src="img/logo_2.png" alt=""> Organisation des Sœurs  Bernardines de Audenaarde </h6>
                    <p>Organisation des Sœurs  Bernardines de Audenaarde</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p><i class="fa fa-phone-alt me-3"></i>+250-788-687-348</p>
                    <p><i class="fa fa-envelope me-3"></i>soeursbernadinedeoudenaarde@gmail.com</p>
                </div>
                <div class="col-lg-3 col-md-6">
